...
def generate_launch_description():
    ...
    pkg_dir = get_package_share_directory('lexus3_sensor_kit_launch')
    params_file_path = Path(pkg_dir) / 'config' / 'lidar.param.yaml'

    print(f'lidar params_file_path: {params_file_path}')
